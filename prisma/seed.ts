...
async function main() {
  ...
  await prisma.user.upsert({
    ...
    create: {
      ...
      business_id: null, // ❗ Multi-tenant rule: Super admin has no business
      status: 'ACTIVE',
    },
  });

  console.log('✔ Super Admin created (no business)');

  // ---------------------------------------------
  // 3️⃣ Plans (Starter / Growth / Scale)
  // ---------------------------------------------
